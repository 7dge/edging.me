...
function popup1() {
    CreativaPopup.create('Feel free to DM me 7dge', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contactding" onclick="allahm109kd();" color="#FF0000">7dge</font><br> <font style="color: #696969; font-size: smaller;"> or my ig <a href="https://instagram.com/9vulns" style="color: #ADD8E6;">https://instagram.com/9vulns</a> </font>', 'Discord/Insta', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
}
...
function allahm109kd() {
    navigator.clipboard.writeText("7dge").then(function() {
...
function allahm109kd1() {
    navigator.clipboard.writeText("7dge");
    setTimeout(function() {
        alert("Discord username was copied to the clipboard");
    }, 50);
}
